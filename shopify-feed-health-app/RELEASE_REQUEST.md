...
- set the production application URL to `https://pal-catalog-check-app.onrender.com`
- set embedded mode explicitly
- publish `https://pal-catalog-check-app.onrender.com/auth/callback` as the production OAuth redirect URL
...
- keep the legacy Render service intact until post-cutover validation passes

Requested: 2026-09-18 — clean Render endpoint cutover
